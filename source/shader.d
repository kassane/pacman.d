...
/*
    ...
    Cmdline:
        sokol-shdc -i shader.glsl -o shader.d -l metal_macos:glsl410:glsl300es:hlsl4 -f sokol_d
    ...
    Shader program: 'offscreen':
        ...
        Fragment shader: fs_offscreen
            ...
            Image Sampler Pair 'pal_tex_smp':
                ...
                Sampler: smp
*/
enum ATTR_VS_DISPLAY_POS = 0;
enum ATTR_VS_OFFSCREEN_IN_POS = 0;
enum ATTR_VS_OFFSCREEN_IN_UV = 1;
enum ATTR_VS_OFFSCREEN_IN_DATA = 2;
enum SLOT_TILE_TEX = 0;
enum SLOT_PAL_TEX = 1;
enum SLOT_TEX = 0;
enum SLOT_SMP = 0;
/*
...
sg.ShaderDesc displayShaderDesc(sg.Backend backend) @trusted @nogc nothrow {
    ...
    switch (backend) {
        case sg.Backend.Glcore:
            ...
            desc.vs.source = &VS_DISPLAY_SOURCE_GLSL410[0];
            desc.vs.entry = "main";
            desc.fs.source = &FS_DISPLAY_SOURCE_GLSL410[0];
            desc.fs.entry = "main";
        ...
        case sg.Backend.Gles3:
            desc.attrs[0].name = "pos";
            desc.vs.source = &VS_DISPLAY_SOURCE_GLSL300ES[0];
            desc.vs.entry = "main";
            desc.fs.source = &FS_DISPLAY_SOURCE_GLSL300ES[0];
            desc.fs.entry = "main";
            desc.fs.images[0].used = true;
            desc.fs.images[0].multisampled = false;
            desc.fs.images[0].image_type = sg.ImageType._2d;
        ...
        case sg.Backend.D3d11:
            ...
            desc.vs.source = &VS_DISPLAY_SOURCE_HLSL4[0];
            desc.vs.d3d11_target = "vs_4_0";
            desc.vs.entry = "main";
            desc.fs.source = &FS_DISPLAY_SOURCE_HLSL4[0];
        ...
        case sg.Backend.Metal_macos:
            desc.vs.source = &VS_DISPLAY_SOURCE_METAL_MACOS[0];
            desc.vs.entry = "main0";
            desc.fs.source = &FS_DISPLAY_SOURCE_METAL_MACOS[0];
            desc.fs.entry = "main0";
            desc.fs.images[0].used = true;
            desc.fs.images[0].multisampled = false;
            desc.fs.images[0].image_type = sg.ImageType._2d;
...
sg.ShaderDesc offscreenShaderDesc(sg.Backend backend) @trusted @nogc nothrow {
    ...
    switch (backend) {
        case sg.Backend.Glcore:
            ...
            desc.vs.source = &VS_OFFSCREEN_SOURCE_GLSL410[0];
            desc.vs.entry = "main";
            desc.fs.source = &FS_OFFSCREEN_SOURCE_GLSL410[0];
            desc.fs.entry = "main";
            desc.fs.images[0].used = true;
            desc.fs.images[0].multisampled = false;
            desc.fs.images[0].image_type = sg.ImageType._2d;
